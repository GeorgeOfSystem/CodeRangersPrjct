...
AuditApproveComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: AuditApproveComponent, selectors: [["app-audit-approve"]], decls: 44, vars: 1, consts: [[1, "example-card"], ["justify-content:center", "", "align-items:center", ""], [3, "formGroup"], [1, "row"], [1, "col"], ["for", "exampleFormControlInput1"], ["type", "text", "formControlName", "nombre", "placeholder", "Empresa", 1, "form-control"], ["formControlName", "negocio", 1, "form-control"], [1, "form-group"], ["type", "email", "formControlName", "direccion", "id", "exampleFormControlInput1", "placeholder", "San miguel Calacoto Local 230", 1, "form-control"], ["for", "exampleFormControlTextarea1"], ["formControlName", "requisitos", "id", "exampleFormControlTextarea1", "rows", "3", 1, "form-control"], ["formControlName", "propuesta", "id", "exampleFormControlTextarea1", "rows", "3", 1, "form-control"], [2, "text-align", "center"], ["mat-button", "", 3, "click"]], template: function AuditApproveComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function AuditApproveComponent_Template_button_click_42_listener() { return ctx.onCreate(); });
