(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~modules-aprobacion-aprobacion-module~modules-audit-approve-audit-approve-module~modules-audi~92018fd8"], {
    /***/
    ...
    function node_modulesAngularCdkFesm2015CdkJs(module, __webpack_exports__, __webpack_require__) {
      ...
      var VERSION = new _angular_core__WEBPACK_IMPORTED_MODULE_0__["Version"]('11.0.1');
      /**
       * @license
       * Copyright Google LLC All Rights Reserved.
       *
    ...
    function node_modulesAngularMaterial__ivy_ngcc__Fesm2015CoreJs(module, __webpack_exports__, __webpack_require__) {
      ...
      var VERSION$1 = new _angular_core__WEBPACK_IMPORTED_MODULE_0__["Version"]('11.0.1');
      /** @docs-private */
      ...
      function mixinColor(base, defaultColor) {
        return /*#__PURE__*/function (_base2) {
          ...
          function _class2() {
            ...
            _this30.defaultColor = defaultColor; // Set the default color that can be specified from the mixin.
      ...
      function mixinTabIndex(base) {
        ...
        var Mixin = /*#__PURE__*/function (_base4) {
          ...
          function Mixin() {
            ...
            _this32.defaultTabIndex = defaultTabIndex;
            return _this32;
          }
      ...
      function mixinInitialized(base) {
        return /*#__PURE__*/function (_base6) {
          ...
          function _class4() {
            ...
            _this34.initialized = new rxjs__WEBPACK_IMPORTED_MODULE_6__["Observable"](function (subscriber) {
        ...
        _createClass(RippleRenderer, [{
          ...
          value: function fadeInRipple(x, y) {
            ...
            this._runTimeoutOutsideZone(function () {
              var isMostRecentTransientRipple = rippleRef === _this39._mostRecentTransientRipple;
              rippleRef.state = 1
              /* VISIBLE */
              ...
              if (!config.persistent && (!isMostRecentTransientRipple || !_this39._isPointerDown)) {
                rippleRef.fadeOut();
              }
            }, duration);
          ...
          value: function _registerEvents(eventTypes) {
            ...
            this._ngZone.runOutsideAngular(function () {
              eventTypes.forEach(function (type) {
                _this40._triggerElement.addEventListener(type, _this40, passiveEventOptions);
              });
            });
          }
          ...
          value: function _removeTriggerEvents() {
            ...
            if (this._triggerElement) {
              pointerDownEvents.forEach(function (type) {
                _this41._triggerElement.removeEventListener(type, _this41, passiveEventOptions);
              });
      ...
      var _MatOptgroupBase = /*#__PURE__*/function (_MatOptgroupMixinBase2) {
        ...
        function _MatOptgroupBase() {
          ...
          _this42 = _super13.apply(this, arguments);
          /** Unique id for the underlying label. */

          _this42._labelId = "mat-optgroup-label-".concat(_uniqueOptgroupIdCounter++);
          return _this42;
        }
    ...
    function node_modulesAngularMaterial__ivy_ngcc__Fesm2015FormFieldJs(module, __webpack_exports__, __webpack_require__) {
      ...
      var MatFormField = /*#__PURE__*/function (_MatFormFieldMixinBas) {
        ...
        var _super16 = _createSuper(MatFormField);
        ...
        _labelOptions, _dir, _defaults, _platform, _ngZone, _animationMode) {
          ...
          _this43 = _super16.call(this, _elementRef);
          ...
          _this43._hintLabelId = "mat-hint-".concat(nextUniqueId$2++); // Unique id for the label element.
        ...
        _createClass(MatFormField, [{
          ...
          value: function ngAfterContentInit() {
            ...
            this._ngZone.runOutsideAngular(function () {
              _this44._ngZone.onStable.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_7__["takeUntil"])(_this44._destroyed)).subscribe(function () {
            ...
            if (this._dir) {
              this._dir.change.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_7__["takeUntil"])(this._destroyed)).subscribe(function () {
                if (typeof requestAnimationFrame === 'function') {
                  _this44._ngZone.runOutsideAngular(function () {
                    requestAnimationFrame(function () {
    ...
    function node_modulesAngularMaterial__ivy_ngcc__Fesm2015InputJs(module, __webpack_exports__, __webpack_require__) {
      ...
      var MatInput = /*#__PURE__*/function (_MatInputMixinBase2) {
        ...
        _formField) {
          ...
          _this47 = _super18.call(this, _defaultErrorStateMatcher, _parentForm, _parentFormGroup, ngControl);
          _this47._elementRef = _elementRef;
          _this47._platform = _platform;
          _this47.ngControl = ngControl;
          _this47._autofillMonitor = _autofillMonitor;
          _this47._formField = _formField;
          _this47._uid = "mat-input-".concat(nextUniqueId++);
          /**
           * Implemented as part of MatFormFieldControl.
           * @docs-private
           */

          _this47.focused = false;
          /**
           * Implemented as part of MatFormFieldControl.
           * @docs-private
           */

          _this47.stateChanges = new rxjs__WEBPACK_IMPORTED_MODULE_7__["Subject"]();
          /**
           * Implemented as part of MatFormFieldControl.
           * @docs-private
           */

          _this47.controlType = 'mat-input';
          /**
           * Implemented as part of MatFormFieldControl.
           * @docs-private
           */

          _this47.autofilled = false;
          _this47._disabled = false;
          _this47._required = false;
          _this47._type = 'text';
          _this47._readonly = false;
          _this47._neverEmptyInputTypes = ['date', 'datetime', 'datetime-local', 'month', 'time', 'week'].filter(function (t) {
            return Object(_angular_cdk_platform__WEBPACK_IMPORTED_MODULE_3__["getSupportedInputTypes"])().has(t);
          });
          var element = _this47._elementRef.nativeElement;
          ...
          _this47._inputValueAccessor = inputValueAccessor || element;
          _this47._previousNativeValue = _this47.value; // Force setter to be called in case id was not specified.

          _this47.id = _this47.id; // On some versions of iOS the caret gets stuck in the wrong place when holding down the delete
          ...
          _this47._isServer = !_this47._platform.isBrowser;
          _this47._isNativeSelect = nodeName === 'select';
          _this47._isTextarea = nodeName === 'textarea';

          if (_this47._isNativeSelect) {
            _this47.controlType = element.multiple ? 'mat-native-select-multiple' : 'mat-native-select';
          }
          ...
          value: function ngAfterViewInit() {
            ...
            if (this._platform.isBrowser) {
              this._autofillMonitor.monitor(this._elementRef.nativeElement).subscribe(function (event) {
                _this48.autofilled = event.isAutofilled;
...
//# sourceMappingURL=default~modules-aprobacion-aprobacion-module~modules-audit-approve-audit-approve-module~modules-audi~92018fd8-es5.js.map